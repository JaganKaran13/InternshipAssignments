...
public class Constants {
	...
	public static final String DISPLAY_SORT_LAST_NAME = "select * from details order by lastname";
	public static final String DISPLAY_SORT_FIRST_NAME = "select * from details order by firstname";
